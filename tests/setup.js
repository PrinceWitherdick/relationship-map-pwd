...
// relationship-map.js, which no test runs, since it registers on the `init` hook.
...
global.renderTemplate = (templatePath, data) => {
	// "modules/relationship-map-pwd/templates/…" is how Foundry addresses a module file; here it is a path
	// relative to the repo root.
	const file = path.join(_systemRoot, String(templatePath).replace(/^modules\/[^/]+\//, ""));
