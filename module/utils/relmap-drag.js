...
//
// POINTER EVENTS, NEVER HTML5 DnD, for the reasons utils/cancellable-drag.js sets out at length
...
import { beginCancellableDrag, endCancellableDrag, isLiftedDrag } from "./cancellable-drag.js";

// ── Escape ───────────────────────────────────────────────────────────────────────────
//
// Escape-to-cancel is IMPORTED, not restated: cancellable-drag.js owns the one capture-phase
...
export function wireRelmapDrag(root, {
	...
	rubber.setAttribute("class", "relmap-rubber");
	 ...
	 * synchronously, which re-enters this function — the same order cancellable-drag.js keeps,
